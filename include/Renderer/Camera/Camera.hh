...
namespace kaTe {
    ...
    public:
        ...
        auto SetProjection(const glm::mat4& projection = glm::mat4(0)) -> const glm::mat4& { m_Projection = projection; }
        ...
        auto SetTransform(const glm::mat4& transform = glm::mat4(0)) -> const glm::mat4& { m_Transform = transform; }
